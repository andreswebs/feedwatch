...
// usage errors (exit 64, empty stdout); a store failure propagates to the boundary.
...
// usageErr builds a whole-invocation usage error that the boundary maps to exit 64.
