...
func TestNewLoggerJSON(t *testing.T) {
	...
	logger := command.NewLogger(&buf, "json", slog.LevelInfo, false)
...
func TestNewLoggerText(t *testing.T) {
	var buf bytes.Buffer
	logger := command.NewLogger(&buf, "text", slog.LevelInfo, false)
...
func TestNewLoggerQuiet(t *testing.T) {
	var buf bytes.Buffer
	logger := command.NewLogger(&buf, "json", slog.LevelDebug, true)
...
func TestNewLoggerLevelHonored(t *testing.T) {
	var buf bytes.Buffer
	logger := command.NewLogger(&buf, "json", slog.LevelWarn, false)
